  ...
  return (
    ...
    <div
      className={cn(
        ...
        "flex h-[340px] cursor-pointer flex-col justify-between p-4 align-middle",
      )}
    >
      {/* <HoverCardTrigger> */}
      ...
      >
        ...
        <span className="mb-4 text-sm text-primary-foreground/80">
        ...
        {/* product name */}
        <h4 className="mb-4 items-start text-lg font-bold text-primary-foreground">
