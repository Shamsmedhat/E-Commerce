  ...
  return (
    <>
      <div className={cn(className, "w-full px-4")}>
        {/* title */}
        <h3 className="border-b-2 border-primary-foreground/10 py-3 text-xl font-semibold uppercase dark:border-white/20">
          {t("ubNic2h-DPEijW_LliPJA")}
        </h3>
        {/* details */}
        <div>
          {/* total items &  subtotal*/}
          <div className="flex justify-between border-b-2 border-primary-foreground/10 py-5 capitalize dark:border-white/20">
            ...
            <div className="flex flex-col space-y-2 text-end">
              <span className="text-primary-foreground/80 dark:text-white/50">
          ...
          <div className="flex flex-col items-center justify-between">
            ...
            {/* shipping info */}
            <div className="flex pb-4 capitalize text-primary-foreground/80 dark:text-white">
