...
// Define the public pages that do not require authentication
...
const authMiddleware = withAuth(
  // Use intlMiddleware after successful authorization
...
export default function middleware(req: NextRequest) {
  ...
  // If the request is for a public page, use intlMiddleware, otherwise use authMiddleware
  if (isPublicPage) {
